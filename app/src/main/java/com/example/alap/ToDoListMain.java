...
public class ToDoListMain extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mainAdapter=new MainAdapter(dataList,ToDoListMain.this);
        //set adapter
        ...
        btAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!sText.equals("")){
                    ...
                    dataList.clear();
                    Toast.makeText(ToDoListMain.this,"Successfully added!",Toast.LENGTH_LONG).show();

                    dataList.addAll(database.mainDao().getAll());
                    mainAdapter.notifyDataSetChanged();

                }else{
                    builder= new AlertDialog.Builder(ToDoListMain.this);
